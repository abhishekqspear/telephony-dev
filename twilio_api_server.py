...
print(f"sid {twilio_account_sid}, token {twilio_auth_token}")
...
async def make_call(request: Request):
    try:
        ...
        twilio_phone_number = call_details.get('from_phone_number',None)
        ...
        # bolna_host="https://c03d-2405-201-3013-2aaa-d003-e35c-788a-fef6.ngrok-free.app"
        try:
